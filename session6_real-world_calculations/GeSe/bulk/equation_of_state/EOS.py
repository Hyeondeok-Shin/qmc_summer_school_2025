...
for scale in scales:
 ...
 system = generate_physical_system(
    ...
    axes   = [[a,0.,0.   ],     # cell axes
              [0.   ,a*0.872146118721461,0.],
              [0.,0.   ,a*2.463470319634703]],
    elem   = ['Ge','Ge','Ge','Ge','Se','Se','Se','Se'],                # 2 C atoms
    pos    = [[0.106    ,0.25    ,0.879    ],  # atomic positions
              [0.394    ,0.25    ,0.379    ],
              [0.894    ,0.75    ,0.121    ],
              [0.606    ,0.75    ,0.621    ],
              [0.503    ,0.25    ,0.148    ],
    ...
    net_spin   = 0,
    net_charge = 0,
    tiling     = [[1, 0, 0],[0, 1, 0],[0, 0, 1]],                 # tile to 16 atom cell
#    symm_kgrid = True,
